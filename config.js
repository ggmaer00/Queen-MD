...
////////////////////////////////////////////////////|:|             OWNER DETAILS             |:|//////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
global.session = process.env.SESSION_ID || 'R1U3UVB6Z2s='
global.ownername = process.env.OWNER_NAME === undefined ? "MAGED.CORAZON" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '201062823926' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'MAGED.CORAZON' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'MAGED.CORAZON' : process.env.STICKER_AUTHOR_NAME
